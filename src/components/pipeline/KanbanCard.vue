...
<template>
  <div
    class="group bg-white rounded-lg shadow-card border border-slate-100 cursor-pointer select-none
    ...
    @click="$emit('click')"
  >
    <!-- Left accent bar using stage color -->
    <div
    ...
    >
      <div class="p-3">
        ...
        <div class="flex items-start gap-2">
          ...
          <div class="opacity-0 group-hover:opacity-40 transition-opacity flex-shrink-0 mt-1 cursor-grab active:cursor-grabbing">
            <svg class="w-3.5 h-3.5 text-slate-400" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- Divider -->
        <div class="border-t border-slate-100 my-2.5" />
        ...
        <div class="flex items-center justify-between gap-2">
          <div class="flex items-center gap-1.5 min-w-0">
            ...
            <span
              ...
              class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-slate-100 text-slate-500 truncate max-w-[80px]"
            >
              {{ application.source }}
            </span>

            <!-- Date -->
            <span class="text-[10px] text-slate-400 flex items-center gap-0.5 flex-shrink-0">
          ...
          <div v-if="avgScore(application) !== null" class="flex items-center gap-0.5 flex-shrink-0">
            <svg
              ...
              :stroke="i <= (avgScore(application) ?? 0) ? '#f59e0b' : '#e2e8f0'"
              stroke-width="2"
            >
          ...
          <div
            ...
            class="text-[10px] text-slate-400 flex items-center gap-0.5 flex-shrink-0"
          >
            <svg class="w-2.5 h-2.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
